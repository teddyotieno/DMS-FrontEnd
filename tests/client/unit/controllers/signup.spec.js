describe('SignUp Controller Unit Tests', function() {
    ...
    describe('SignUp Controller Unit Test', function() {
        ...
        it('Should test for password length', function() {
            ...
            $scope.signup();
            expect($scope.messageSignup).toBe('Password length needs to be greater than 8 characters');
        });
        ...
        it('Should test that password contains both numbers and non-word characters', function() {
            ...
            $scope.signup();
            expect($scope.messageSignup).toBe('Password should contain both numbers and non-word characters');
        });
        ...
        it('Should test that password contains both uppercase and lowercase characters', function() {
            ...
            $scope.signup();
            expect($scope.messageSignup).toBe('Password should contain both uppercase and lower characters');
        });
        ...
        it('Should test that password matches confirmation password', function() {
            ...
            $scope.signup();
            expect($scope.messageSignup).toBe('Confirmation password does not match initial password given');
        });
